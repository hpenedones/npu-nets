...
constexpr int IN_H = 7;
constexpr int IN_W = 7;
constexpr int IN_C = 8;
...
void conv3_forward_relu_bf16(bfloat16 *x, bfloat16 *w, bfloat16 *y, bfloat16 *ckpt)
{
...
void conv3_backward_update_bf16(bfloat16 *ckpt, bfloat16 *w, bfloat16 *gy, bfloat16 *gx)
{
    bfloat16 *x = ckpt;
    bfloat16 *mask = ckpt + INPUT_ELEMS;
